...
![Login page](./personal-book-manager/screenshots/login.png)

### Sign Up

![Sign up page with existing account error](./personal-book-manager/screenshots/signup-error.png)

### Dashboard

![Empty dashboard](./personal-book-manager/screenshots/dashboard-empty.png)

![Dashboard with stats](./personal-book-manager/screenshots/dashboard-stats.png)

### Add & Manage Books

![Add a book and view collection](./personal-book-manager/screenshots/add-book-collection.png)

![Edit a book](./personal-book-manager/screenshots/edit-book.png)

### Filters

![No books match filters](./personal-book-manager/screenshots/filter-no-results.png)

### Login Filled

![Login page filled in](./personal-book-manager/screenshots/login-filled.png)
